...
/**
 Base class for all UseTabGroup views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the UseTabGroup view hierarchy (such as wrapped iOS UIViews) was touched.
