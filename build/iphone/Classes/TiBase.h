...
// in simulator we redefine to format for UseTabGroup Developer console
...
{\
	NSString * exceptionName = [@"org.usetabgroup." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.usetabgroup";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIUseTabGroupNativeItemNone = -1, 
	UIUseTabGroupNativeItemSpinner = -2,
	UIUseTabGroupNativeItemProgressBar = -3,
	
	UIUseTabGroupNativeItemSlider = -4,
	UIUseTabGroupNativeItemSwitch = -5,
	UIUseTabGroupNativeItemMultiButton = -6,
	UIUseTabGroupNativeItemSegmented = -7,
	
	UIUseTabGroupNativeItemTextView = -8,
	UIUseTabGroupNativeItemTextField = -9,
	UIUseTabGroupNativeItemSearchBar = -10,
	
	UIUseTabGroupNativeItemPicker = -11,
	UIUseTabGroupNativeItemDatePicker = -12,
	
	UIUseTabGroupNativeItemInfoLight = -13,
	UIUseTabGroupNativeItemInfoDark = -14,
	
	UIUseTabGroupNativeItemDisclosure = -15,
	
	UIUseTabGroupNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all UseTabGroup instances of
