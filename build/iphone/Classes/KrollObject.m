...
//@interface UseTabGroupObject : NSObject
//@end

@interface UseTabGroupObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[UseTabGroupObject class]])
		{
			for (NSString *key in [[(UseTabGroupObject*)o modules] allKeys])
			{
