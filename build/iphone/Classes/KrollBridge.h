...
@interface UseTabGroupObject : KrollCoverageObject {
#else
@interface UseTabGroupObject : KrollObject {
#endif
@private
...
extern NSString * UseTabGroup$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	UseTabGroupObject *_usetabgroup;
    KrollObject* console;
	BOOL shutdown;
